...
- [ 3학년 겨울방학 ] 공군 IT개발병(정보체계개발병) 1차합격/최종불합격
...
- 한국장학재단 창업기숙사 예비선발
- 소프트웨어마에스트로 17기 서울캠 최종불합격
- 출석&기숙사 프로그램 유지보수 중   
여담 : 기숙사(이용자수 108명), 출석(이용자수 5662명)   
- [2026.03.11 ~ 진행중 ] 한이음 드림업겸 4학년 졸업작품 - 빌드&배포 자동화플랫폼
- [2026.03.27 ~ 진행중 ] 고급인공지능 중간프로젝트 - 포커 트레이닝 게임
- 소프트웨어마에스트로 17기 부산캠 선발과정중
