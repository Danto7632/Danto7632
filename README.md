...
<details>
<summary><b>🧑‍🎓 중학생</b></summary>

- 2017 **사도장학회 장학생**으로 중학교 입학
- 복싱 3개월 *체육관
- 오케스트라 입단 (타악기 - 글로켄슈필) *동아리  
연주한 곡들 : <a href="https://www.youtube.com/watch?v=Ley7uiqSs2I">Ross Roy</a>, <a href="https://www.youtube.com/watch?v=O6Gd_eN2fWQ">The power of Korea</a>, <a href="https://www.youtube.com/watch?v=qiR0mCxK7Sc">Fate of the gods</a>   
수상 후 <a href="https://youtu.be/cAplKSip6iA?si=L8-Y8CZzIRmzgnx3&t=4703">대전예술의전당에서 한국의 힘(The power of Korea) 연주</a>
...
개발 프로젝트(1인) : <a href="https://github.com/Danto7632/number_guess_game">number_guess_game</a>
- 템플릿기반 '미래의 회사 웹페이지' 개발   
개발 프로젝트(1인) : <a href="https://github.com/Danto7632/OtterCompany">OtterCompany</a>
...
개발 프로젝트(1인) : <a href="https://github.com/Danto7632/otter_s_journey">otter_s_journey</a>
- 2022 KOI 정보올림피아드 미수상 (당시 어렵다고 느꼈음)
</details>

<details>
<summary><b>🎓 대학생(전문학사)</b></summary>

- **개교 60주년 기념 리더장학생 선정(석차2위)**
- 배드민턴 1년 *교양, 동아리, 동호회
- 외주 2년(41건), 수학학원 7개월, 수학과외 3개월, 편의점 3개월, 교내근로 6개월
- 교내 QR출석&기숙사 프로그램 개발 및 배포
- PCCE LV3 / 정보처리산업기사 취득
...
개발 프로젝트(3인, 팀장) : <a href="https://github.com/Danto7632/UniTechHub">UniTectHub</a>(현재비공개)
...
개발 프로젝트(1인) : BatsBot(업로드안할예정)
- 2학년 여름방학 개인프로젝트(하루) - 동아리 EL 홍보페이지ver.1(React)   
개발 프로젝트(1인) : <a href="https://github.com/Danto7632/ELPromotionPage">ELPromotionPage</a>
- **[2024.04.16 ~ 10.22 ] EXPO 프로젝트 - AI 손 발달 및 재활 운동 플랫폼**   
개발 프로젝트(14인, 팀장) : <a href="https://github.com/Danto7632/LeafTale">LeafTale</a>   
여담 : 2025년 02월 21일자를 기준으로 지식재산권 특허 출원 신청
...
- **[2025.03.10 ~ 11.12 ] 3학년 졸업작품 - 코드 시각화 플랫폼**   
...
- 한국장학재단 창업기숙사 예비선발
- 교내 QR출석(5662명)&기숙사(108명) 프로그램 유지보수
- 기숙사선발 자동화 프로그램 개발 및 배포
- **AI·SW 마에스트로 부산센터 17기 연수생**
<h4>🧩 4학년</h4>

- **[ 2026.03.11 ~ 진행중 ] 한이음 드림업겸 4학년 졸업작품 - 빌드&배포 자동화플랫폼**  
개발 프로젝트(4인, 팀장) : [Qeploy](https://github.com/Dvely)

- [ 2026.03.27 ~ 04.17 ] 고급인공지능 중간프로젝트 - 포커 트레이닝 게임   
개발 프로젝트(4인, 팀장) : [AIPOT](https://github.com/Dvely/Dvely_AIPOT)

- [ 2026.04.13 ] Open Source Contributions - [mazassumnida](https://github.com/mazassumnida/mazassumnida/pull/45)

- [ 2026.05.08 ~ 06.19 ] 고급인공지능 기말프로젝트 - 실내 내비게이션 서비스  
개발 프로젝트(4인) : InRoute(비공개)

- [ 2026.05.23 ~ 06.13 ] ASM AI기술교육 프로젝트 - 협업 과정에서의 용어해석 서비스  
개발 프로젝트(5인) : [ContextBridge](https://github.com/spaceIlive/sw_maestro_ai_study)

- **[ 2026.05 ~ 진행중 ] AI·SW 마에스트로 프로젝트 - 아이 사진 서비스**  
개발 프로젝트(3인, 팀장) : 비공개

- [ 2026.07.17 ] Open Source Contributions - [bathos](https://github.com/taxideftis/bathos/pull/21)
</details>
...
- **[ 2025.11.19 ] 2025 한이음 드림업 공모전 (장려상) \*한국정보산업연합회장상**
- [ 2025.11.21 ] 2025 Digitech 캡스톤디자인 경진대회 (장려상-Abeek상) *한국공학교육인증원상
...
- [ 2026.01.16 ] 2025 Digi-STAR Program in Busan 경진대회 (우수상) *디지텍고등직업교육협의회장상
</details>

<details>
<summary><b>✅️ 수료증/인증서</b></summary>

- [ 2020.11.21 ~ 11.27 ] 동계 SW융합 창작 캠프 *수료   
교육과정 : 인공지능 모델을 적용한 나만의 홈페이지 만들기   
개발프로젝트(1인) : <a href="https://github.com/Danto7632/template">template</a>

- **[ 2021.01.06 ~ 03.19 ] FTC-Qualcomm 장학팀 선정 \*장학증서**   
개발프로젝트(13인, 팀장) : 흔들 골 회수 및 운송 & 링 회수 및 발사 로봇(작성예정)   
여담 : 팀 구성일이 13일 금요일 이었고, 인원도 13명이라 팀 명을 '13인의 금요일'로 지음
...
기획 프로젝트(4인, 팀장) : 노코드 머신러닝 NoCodeML(업로드고민중)
- [ 2024.11.21 ~ 11.23 ] 제주형 스마트팩토리 캠프(2박3일) *수료
- **[2025.03.07 ~ 10.31 ] 한이음 드림업 프로젝트 - Project Management System \*수행확인서**   
개발 프로젝트(5인) : [Navis(작성예정)](https://youtu.be/SwTJSwHKsIk?si=2bhPWejaHCop3xIT)   
여담 : 중간평가 결과 - 우수 프로젝트 선정(상위30%)
...
- **[ 2025.11.19 ] 2025 한이음 드림업 엑스포 서울 KINTEX 작품포스터 전시**(Navis)

**Zivorp**
- [2025.11.21 ] 2025 Digitech 캡스톤디자인 경진대회 인하공전 작품전시(Zivorp)
- **[2025.11.28 ] 2025 대한전자공학회 추계학술대회 포스터세션 발표**(Zivorp)   
학회지 작성(6인,주저자) : [언어 비의존 코드 실행 시각화를 위한 최소 이벤트 스키마와 웹 기반 재생 파이프라인](https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE12551263)
</details>

<details>
<summary><b>🎖️ 중·고등학교 교과수상(외전)</b></summary>
...
<div align="center">
  <table>
    <tr>
      <td>
        <img src="https://github-readme-stats-seven-lemon-15.vercel.app/api?username=danto7632&show_icons=true&theme=gruvbox" alt="GitHub stats">
      </td>
      <td>
